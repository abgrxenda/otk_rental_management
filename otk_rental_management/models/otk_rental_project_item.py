...
class OtkRentalProjectItem(models.Model):
    _name = 'otk.rental.project.item'
    ...
    assigned_serial_ids = fields.Many2many(
        ...
        'otk_rental_project_item_serial_rel',
        'item_id',
        'serial_id',
    ...
    image_ids = fields.Many2many(
        'ir.attachment',
        'otk_rental_project_item_image_rel',
        'item_id',
        'attachment_id',
        string='Photos'
    )
        ...
        if len(available_serials) < needed:
            ...
            if self.equipment_id.auto_generate_serials:
                ...
                for i in range(shortage):
                    self.env['otk.rental.equipment.serial'].create({
    ...
    def action_view_serials(self):
        ...
        return {
            ...
            'res_model': 'otk.rental.equipment.serial',
            'view_mode': 'list,form',
