...
class OtkRentalReturnWizard(models.TransientModel):
    _name = 'otk.rental.return.wizard'
    ...
    return_photos = fields.Many2many(
        'ir.attachment',
        'otk_partial_return_wizard_photo_rel',
        'wizard_id',
        'attachment_id',
...
class OtkRentalReturnWizardLine(models.TransientModel):
    _name = 'otk.rental.return.wizard.line'
    _description = 'Return Wizard Line'

    wizard_id = fields.Many2one(
        'otk.rental.return.wizard',
        string='Wizard',
        required=True,
        ondelete='cascade'
    )
